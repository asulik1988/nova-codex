...
import { getAllBedrockModels } from "./bedrock-access-gateway.js";
...
export async function getAvailableModels(
  ...
  // Special case for AWS Bedrock - get models from bedrock-access-gateway.ts
  if (provider.toLowerCase() === "bedrock") {
    return getAllBedrockModels();
  }
  
  // For all other providers, fetch models dynamically
